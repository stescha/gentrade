...
def evaluate(
    ...
    """Evaluate an individual's fitness as F1 score against ground truth.
...
def main() -> None:
    ...
    best = hof[0]
    print(f"Best individual (F1 = {best.fitness.values[0]:.4f}):")
    print(f"  {str(best)}")
    print()
    ...
    for i, ind in enumerate(hof):
        print(f"  {i+1}. F1={ind.fitness.values[0]:.4f}: {str(ind)[:80]}...")
    print()
