...
cfg = RunConfig(
    ...
    metrics=(
        config.MeanPnlMetricConfig(min_trades=30),
        # config.CalmarMetricConfig(weight=1.0, min_trades=30),
        # config.SharpeMetricConfig(weight=1.0, min_trades=30),
        config.TotalReturnMetricConfig(min_trades=30),
    ),
    ...
    metrics_val=(
        # SharpeMetricConfig(weight=1.0, min_trades=30),
        # CalmarMetricConfig(weight=1.0, min_trades=30),
        config.MeanPnlMetricConfig(min_trades=1),
        config.TotalReturnMetricConfig(min_trades=1),
        # marMetricConfig(weight=1.0, min_trades=1),
    ),
