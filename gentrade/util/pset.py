...
def create_ta_pset(name='pset_talib', talib_funcs=[], talib_ignore_cats=TALIB_IGNORE_CATS, talib_ignore_funcs=TALIB_IGNORE_FUNCS):
    pset = gp.PrimitiveSetTyped(name, [OHLCVFrame, PriceSeries, PriceSeries, PriceSeries, PriceSeries, PriceSeries], BooleanSeries)
    ...
    add_custom(pset)
        # pset.addPrimitive(ta_abstract.SMA, [PriceSeries, Timeperiod], NumericSeries, name='SMAYY')
