...
class Timeperiod:
    ...
    @classmethod
    def sample(cls) -> int:
        ts = [3, 5, 6, 7, 8, 9, 10, 12, 16, 20, 24, 30, 36, 42, 48, 52, 56, 60, 66,
              72, 80, 88, 96, 104, 112, 120, 128, 136, 144, 152, 160, 168, 176, 184,
              192, 200, 216, 224, 232, 240, 248, 256, 264, 272, 280, 288, 296, 304,
              312, 320, 328, 336, 344, 352, 360, 368, 376, 384, 392, 400, 408, 416,
              424, 432, 440, 448, 456, 464, 472, 480, 488, 496, 504, 512, 520, 528,
              536, 544, 552, 560, 568, 576, 584, 592, 600, 608, 616, 624]
