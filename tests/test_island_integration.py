...
class TestAlgorithmSelection:
    ...
    def test_zero_migration_rate_returns_eamupluslambda(self) -> None:
        ...
        # Set _fit_ attrs to satisfy create_algorithm contract
        from unittest.mock import MagicMock
        opt._fit_evaluator_ = MagicMock()
        opt._fit_train_data_ = []
        opt._fit_train_entry_labels_ = None
        opt._fit_train_exit_labels_ = None
...
class TestIslandOptimizerFit:
    ...
    def test_all_fitness_valid_after_island_fit(
    ...
    def test_standard_mode_demes_is_single_list(
        self, island_df: pd.DataFrame
    ) -> None:
