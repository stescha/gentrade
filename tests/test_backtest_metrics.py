...
from gentrade.evaluators import BacktestEvaluator, _compile_tree_to_signals  # noqa: E402
...
class TestBacktestMetricConfig:
    ...
    def test_classification_configs_are_not_backtest(
...
class TestBacktestEvaluator:
    ...
    def test_returns_tuple_of_one_float(self) -> None:
        ...
        df = self._make_df()
        evaluator = BacktestEvaluator(BacktestEvaluatorConfig())
