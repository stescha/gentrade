...
def MACDEXT_macd(
    close, fastperiod, fastmatype, slowperiod, slowmatype, signalperiod, signalmatype
):
...
def add_momentum_indicators(pset):
    ...
    pset.addPrimitive(
        talib.APO, [PriceSeries, Timeperiod, Timeperiod, MAType], NumericSeries
    )
    ...
    pset.addPrimitive(
        MACDEXT_macd,
        [PriceSeries, Timeperiod, MAType, Timeperiod, MAType, Timeperiod, MAType],
        NumericSeries,
    )
    pset.addPrimitive(
        MACDEXT_macdsignal,
    ...
    pset.addPrimitive(
        talib.PPO, [PriceSeries, Timeperiod, Timeperiod, MAType], NumericSeries
    )
    ...
    pset.addPrimitive(
        STOCHF_fastk, [High, Low, Close, Timeperiod, Timeperiod, MAType], NumericSeries
    )
    pset.addPrimitive(
        STOCHF_fastd, [High, Low, Close, Timeperiod, Timeperiod, MAType], NumericSeries
    )
    pset.addPrimitive(
        STOCHRSI_fastk,
        [PriceSeries, Timeperiod, Timeperiod, Timeperiod, MAType],
        NumericSeries,
    )
    pset.addPrimitive(
        STOCHRSI_fastd,
    ...
    pset.addPrimitive(
        talib.ULTOSC,
        [High, Low, Close, Timeperiod, Timeperiod, Timeperiod],
        NumericSeries,
    )
...
def add_overlap_studies(pset):
    ...
    pset.addPrimitive(talib.SAR, [High, Low, Acceleration, Maximum], NumericSeries)
...
def add_statistic_functions(pset):
    ...
    pset.addPrimitive(
        talib.LINEARREG_INTERCEPT, [PriceSeries, Timeperiod], NumericSeries
    )
