...
class BaseTreeOptimizer(BaseOptimizer, ABC):
    ...
    def __init__(
        ...
        *,
        ...
        replace_selection_op: SelectionOp[Any] = tools.selWorst,  # type: ignore[assignment]
    ) -> None:
        super().__init__(
            metrics=metrics,
            mu=mu,
    ...
    def _validate_migration_params(self) -> None:
        """Validate island migration parameter consistency.
    ...
    def create_algorithm(
        ...
        if self.migration_rate > 0:
            ...
            return IslandEaMuPlusLambda(
                ...
                evaluator=self._fit_evaluator_,
                train_data=self._fit_train_data_,
                train_entry_labels=self._fit_train_entry_labels_,
                train_exit_labels=self._fit_train_exit_labels_,
